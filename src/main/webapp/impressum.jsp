	...
	<body>
		...
		<div class="row">
			<div class="large-12 columns">
				...
				<p>Hackerspace Bremen e.V.<br/>Bornstr. 14-15<br/>28195 Bremen
				<br/><br/>
				Telefon: <a href="tel:+4942114629215">0421 14 62 92 15</a><br/>Fax: <a href="fax:+4942114629908">0421 14 62 99 08</a><br/>
				E-Mail: <a href="mailto:info@hackerspace-bremen.de" target="_blank">info@hackerspace-bremen.de</a></p>
				<h3>Vorstand</h3>
				<p>Der Hackerspace Bremen e.V. wird vertreten durch den Vorstand Peter Böhm, Jens Bretschneider, 
				Christoph Fretter, Steve Liedtke, Daniel Wendt-Fröhlich.<br/><br/>
				Für die Inhalte auf dieser Webseite ist Steve Liedtke verantwortlich.<br/><br/>
				Der Hackerspace Bremen e.V. ist seit dem 21.02.2012 mit der Nummer VR7556 über das Amtsgericht 
				Bremen im Vereinsregister eingetragen.<br/><br/>
				Wir sind wegen Förderung der Volksbildung (§52 Abs. 2 Nr. 7 AO) nach dem letzten uns zugegangenen 
				Freistellungsbescheid bzw. nach der Anlage zum Körperschaftssteuerbescheid des Finanzamts 
				Bremen-Mitte Steuernummer 460/147/11161 vom 24.07.2013 nach §5 Abs. 1 Nr. 9 des 
				...
				Die Nutzung der Inhalte der Website erfolgt auf eigene Gefahr des Nutzers. Namentlich gekennzeichnete 
				Beiträge geben die Meinung des jeweiligen Autors und nicht immer die Meinung des Anbieters wieder. 
				Mit der reinen Nutzung der Website des Anbieters kommt keinerlei Vertragsverhältnis zwischen dem Nutzer 
				und dem Anbieter zustande.</p>
				...
				Links bedeutet nicht, dass sich der Anbieter die hinter dem Verweis oder Link liegenden Inhalte zu 
				Eigen macht. Eine ständige Kontrolle dieser externen Links ist für den Anbieter ohne konkrete Hinweise 
				...
				bedarf der vorherigen schriftlichen Zustimmung des Anbieters oder jeweiligen Rechteinhabers. Dies gilt 
				insbesondere für Vervielfältigung, Bearbeitung, Übersetzung, Einspeicherung, Verarbeitung bzw. Wiedergabe 
				von Inhalten in Datenbanken oder anderen elektronischen Medien und Systemen. Inhalte und Rechte Dritter 
				sind dabei als solche gekennzeichnet. Die unerlaubte Vervielfältigung oder Weitergabe einzelner Inhalte 
				oder kompletter Seiten ist nicht gestattet und strafbar. Lediglich die Herstellung von Kopien und 
				Downloads für den persönlichen, privaten und nicht kommerziellen Gebrauch ist erlaubt.<br/><br/>
				...
				erwünscht, es sei denn der Anbieter hatte zuvor seine schriftliche Einwilligung erteilt oder es besteht 
				...
				bis 4. abweichen, wird an entsprechender Stelle ausdrücklich darauf hingewiesen. In diesem Falle gelten 
				...
				http://tools.google.com/dlpage/gaoptout?hl=de</a>) verfügbare Browser-Plugin herunterladen und 
				installieren.

				Sie können die Erfassung durch Google Analytics verhindern, indem Sie auf folgenden Link klicken. Es 
				wird ein Opt-Out-Cookie gesetzt, der die zukünftige Erfassung Ihrer Daten beim Besuch dieser Website 
				...
				http://www.google.com/analytics/terms/de.html</a> bzw. unter 
				<a href="http://www.google.com/intl/de/analytics/privacyoverview.html" 
				target="_blank">http://www.google.com/intl/de/analytics/privacyoverview.html</a>. 
				Wir weisen Sie darauf hin, dass auf dieser Website Google Analytics um den Code 
				„gat._anonymizeIp();“ erweitert wurde, um eine anonymisierte Erfassung von IP-Adressen (sog. IP-Masking) 
				zu gewährleisten.<br/><br/>Quelle: 
				<a href="http://www.datenschutzbeauftragter-info.de/" target="_blank">www.datenschutzbeauftragter-info.de
				</a></p>
			</div>
		</div>
